...
function RegisterPage() {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
      <div>
        <p className="text-xs tracking-[0.16em] text-muted-foreground uppercase">Shop counter</p>
        <h1 className="font-display text-4xl">Sell</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Every sale reduces stock. The customer shop updates at once.
        </p>
        <Input
          className="mt-4"
          value={q}
